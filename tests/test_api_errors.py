...
class TestApiErrors(object):
    ...
    def test_no_database_result_found_response(self):
        from application.api.errors import database_not_found_error_handler
    ...
    def test_bad_request_handler_response(self):
        from application.api.errors import bad_request_handler
    ...
    def test_default_error_handler_response(self):
        from application.api.errors import default_error_handler
